  ...
  <body>
	...
	<form role="form" action ="#" method="post">
		...
		<div class="row">
		  ...
		  <div class="col-xs-6"><button id="joinButton" type="submit" class="btn btn-info">Join</button><button id="leaveButton" type="button" class="btn btn-primary">Leave</button></div>
		  <!---->
